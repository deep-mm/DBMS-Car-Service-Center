...
public class CreateTableController {
  ...
  public boolean CreateCustomer() {
    ...
    .append("FOREIGN KEY (SERVICE_CENTER_ID) REFERENCES SERVICE_CENTER(SERVICE_CENTER_ID), ")
  ...
  public boolean CreateCustomerCar() {
    ...
    .append("SERVICE_CENTER_ID INTEGER, ")
    .append("CAR_ID INTEGER, ")
    .append("FOREIGN KEY (CUSTOMER_ID, SERVICE_CENTER_ID) REFERENCES CUSTOMER(CUSTOMER_ID, SERVICE_CENTER_ID), ")
    .append("FOREIGN KEY (CAR_ID) REFERENCES CAR(CAR_ID), ")
  ...
  public boolean CreateSalariedEmployee() {
    ...
    .append("FOREIGN KEY (EMPLOYEE_ID, SERVICE_CENTER_ID) REFERENCES EMPLOYEE(EMPLOYEE_ID, SERVICE_CENTER_ID), ")
    .append("PRIMARY KEY (EMPLOYEE_ID, SERVICE_CENTER_ID) )")
    .toString();
  ...
  public boolean CreateSwapSlot() {
    ...
    .append("STATUS INTEGER NOT NULL, ")
    .append("CHECK (STATUS IN (0,1,2)), ")
    .append("FOREIGN KEY (REQUESTOR_EMPLOYEE_ID, REQUESTOR_SERVICE_CENTER_ID) REFERENCES EMPLOYEE(EMPLOYEE_ID, SERVICE_CENTER_ID), ")
    .append("FOREIGN KEY (REQUESTED_EMPLOYEE_ID, REQUESTED_SERVICE_CENTER_ID) REFERENCES EMPLOYEE(EMPLOYEE_ID, SERVICE_CENTER_ID), ")
  ...
  public boolean CreateRepairService() {
    ...
    .append("CATEGORY_ID INTEGER, ")
    .append("FOREIGN KEY (ID) REFERENCES SERVICE(ID), ")
    .append("FOREIGN KEY (CATEGORY_ID) REFERENCES SERVICE_CATEGORY(CATEGORY_ID), ")
  ...
  public boolean CreateMaintenanceService() {
    ...
    .append("SCHEDULE_BUNDLE_ID INTEGER, ")
    .append("FOREIGN KEY (ID) REFERENCES SERVICE(ID), ")
    .append("FOREIGN KEY (SCHEDULE_BUNDLE_ID) REFERENCES SCHEDULE_BUNDLE(SCHEDULE_BUNDLE_ID), ")
