...
public class ScheduleBundleController {
    ...
    public List<ScheduleBundle> getScheduleBundle() {
    ...
    public ScheduleBundle getScheduleBundleByName(@PathVariable int id) {
    ...
    public boolean updateScheduleBundle(
            @PathVariable int id,
            @RequestBody ScheduleBundle scheduleBundle
    ) {
        String sql =
                "UPDATE SCHEDULE_BUNDLE SET NAME = ? WHERE SCHEDULE_BUNDLE_ID = ?";
